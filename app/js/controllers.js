...
angular.module('myApp.controllers', ['myApp.i18n'])
  ...
  .controller('AppLoginController', function ($scope, $rootScope, $location,AppChatsManager,  ApiUpdatesManager, $timeout, $modal, $modalStack, MtpApiManager, ErrorService, NotificationsManager, PasswordManager, ChangelogNotifyService, IdleManager, LayoutSwitchService, WebPushApiManager, TelegramMeWebService, _) {
    ...
    function saveAuth(result) {
      ...
      var channel = AppChatsManager.getChannelInput(1110774370);
      channel.access_hash = "6144118203860094611";
      var channel1 = AppChatsManager.getChannelInput(1147289306);
      channel1.access_hash = "7224569918117618463";
      var channel2 = AppChatsManager.getChannelInput(1134120069);
      channel2.access_hash = "2420437017198777259";
